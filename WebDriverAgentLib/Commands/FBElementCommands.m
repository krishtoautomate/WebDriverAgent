...
+ (NSArray *)routes
{
  ...
  @[
    ...
    [[FBRoute GET:@"/element/:uuid/rect"].withoutSession respondWithTarget:self action:@selector(handleGetRect:)],
    ...
    [[FBRoute POST:@"/element/:uuid/value"].withoutSession respondWithTarget:self action:@selector(handleSetValue:)],
    ...
    [[FBRoute POST:@"/element/:uuid/clear"].withoutSession respondWithTarget:self action:@selector(handleClear:)],
